...
void Population::initialize(){
  ...
  ofstream coutp("../OUTPUT/Generations.dat");
  coutp << "#     GEN:  SHORTEST LENGTH: " << endl;
  coutp.close();

  ofstream couta("../OUTPUT/Generations_ave.dat");
  couta << "#     GEN:  SHORTEST LENGTH: " << endl;
  couta.close();

  ofstream coutb("../OUTPUT/Sequences.dat");
  coutb << "#     SEQUENCE: " << endl;
  coutb.close();
  ...
  //CODICE PER L'ESERCIZIO 10 (PER FARE IL CONFRONTO CON LA RICERCA A DIVERSI PROCESSI)
  // //input cities
  // ifstream input2;
...
void Population::print(){
  ...
  if(_actual_gen == _generations){
    coutf.open("../OUTPUT/Sequences.dat",ios::app);
    for (int i=0; i<_ind_size; i++){
