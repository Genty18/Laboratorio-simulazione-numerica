...
double get_random_theta(Random &rnd){
...
int main() {
   ...
   if (input.is_open()){
    ...
    int M=10000, N=100, lenght_rw=100;
    double L=M/N, x=0, y=0, z=0, a=1, phi=0, theta=0;

    ofstream outfile("dataCONT.dat");
